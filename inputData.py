...
in_path='E:\data_lung\LIDC-IDRI'
in_path_1_xml="E:\data_lung\LIDC-IDRI\LIDC-IDRI-0001\01-01-2000-30178\3000566.000000-03192"
out_path='E:\out_data'
...
i=0
j=0
if os.path.exists(new_txt_root):# maybe should idtifide
